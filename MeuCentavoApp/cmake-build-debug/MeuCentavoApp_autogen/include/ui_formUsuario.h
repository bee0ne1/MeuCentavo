...
public:
    ...
    void setupUi(QWidget *formUsuario)
    {
        ...
        labelStatus = new QLabel(formUsuario);
        labelStatus->setObjectName("labelStatus");
        labelStatus->setAlignment(Qt::AlignmentFlag::AlignCenter);

        gridLayout->addWidget(labelStatus, 2, 1, 1, 1);
        ...
        gridLayout->addLayout(layoutUsuarios, 4, 1, 1, 1);
        ...
        gridLayout->addLayout(horizontalLayout_2, 5, 1, 2, 2);
    ...
    void retranslateUi(QWidget *formUsuario)
    {
        ...
        labelStatus->setText(QCoreApplication::translate("formUsuario", "status", nullptr));
