...
export declare type ItemProductStepWarningCode = typeof ITEM_PRODUCT_STEP_WARNING_CODES[number];
export declare type ItemProductStepWarning = {
...
export declare type ItemProductState = {
 ...
 */
export declare type ItemProductsStatusDetail = {
