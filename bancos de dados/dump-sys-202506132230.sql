...
('statement_truncate_len','64','2025-06-12 23:26:55',NULL),
('statement_performance_analyzer.limit','100','2025-06-12 23:26:55',NULL),
('statement_performance_analyzer.view',NULL,'2025-06-12 23:26:55',NULL),
('diagnostics.allow_i_s_tables','OFF','2025-06-12 23:26:55',NULL),
('diagnostics.include_raw','OFF','2025-06-12 23:26:55',NULL),
('ps_thread_trx_info.max_length','65535','2025-06-12 23:26:55',NULL);
...
/*!50003 SET collation_connection  = utf8mb3_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`mariadb.sys`@`localhost` FUNCTION `quote_identifier`(in_identifier TEXT) RETURNS text CHARSET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci
    NO SQL
    DETERMINISTIC
    SQL SECURITY INVOKER
...
-- Dump completed on 2025-06-13 22:30:46
